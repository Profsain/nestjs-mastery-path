            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-12">
                ...
                <div className="rounded-2xl border border-border/50 bg-card p-6 shadow-sm">
                  ...
                  <p className="text-sm text-muted-foreground">{project.steps.length} implementation phases from setup to final delivery.</p>
                </div>
                <div className="rounded-2xl border border-border/50 bg-card p-6 shadow-sm">
                  ...
                  <p className="text-sm text-muted-foreground">A fully functional, structured, and tested NestJS application.</p>
                </div>
              </div>

              <div className="rounded-2xl bg-muted/30 p-8 border border-border/40">
                <h2 className="text-2xl font-bold mb-4">Are you ready?</h2>
                <p className="text-muted-foreground mb-6">This project will challenge you to apply everything you've learned in this module. Take your time, focus on quality, and follow the steps.</p>
                <Button size="lg" onClick={() => setActiveStep(0)} className="rounded-xl shadow-lg shadow-primary/20">
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="mt-16 flex items-center justify-between border-t border-border/40 pt-10">
                ...
                {activeStep === project.steps.length - 1 ? (
                  ...
                  <Button onClick={() => setActiveStep(activeStep + 1)} className="shadow-lg shadow-primary/20">
